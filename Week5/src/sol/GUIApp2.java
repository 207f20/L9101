...
public class GUIApp2 extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		// View
		GUIView guiView1 = new GUIView(); // replacing this with GUIView2 instance changes the view
		GUIView guiView2 = new GUIView(); // replacing this with GUIView2 instance changes the view
		...
		grid.add(b1, 0, 0);
		grid.add(b2, 0, 1);
		grid.add(guiView1, 1, 0);
		grid.add(guiView2, 1, 1);
