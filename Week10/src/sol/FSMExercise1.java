...
public class FSMExercise1 {
	...
	// EXERCISE 1: Describe what this recognizes by filling in the javadoc below.
	// You can run this file to test out your answer by trying out different strings and seeing if the fsm matches them.
	/**
	 * This function represents an FSM that matches strings which contain only alphabetical
	 * letters, and if any of the letters are uppercase, they must occur before any lowercase letters
	 * in the string.
	 * 
